...
#
#  Note that when you run this script it tests for the presence of a .mat file
...
#---------------------------------------------------------------------------------------
    ...
    # Parent...
    par_dir    = '/batavia/ATLBIG/';
    par_grd    = 'atlbig_grd.nc';
    par_file   = 'HIS/atlbig';
    par_thetas = 7.0;
    par_thetab = 2.0;
    par_hc     = 300.0;
    ...
    % Child...
    chd_dir    = '/batavia/GULFS/';
    chd_grd    = 'gulfs_grd.nc';
    chd_thetas = 7.0;
    chd_thetab = 2.0;
    chd_hc     = 300.0;
    chd_N      = 50;
...
%---------------------------------------------------------------------------------------
    ...
    bry_filename         = 'gulfs_bry.nc'; % bry filename
    bry_type             = 'his';          % 'avg', 'his' or 'rst'
    total_num_files      =  24;            % number of files to read
    first_file           =  70;            % first avg/his file, eg roms_avg.0282.nc gives 282
