  function [lon4,lat4,pm,pn,ang,lone,late] = global_grid(nx,ny,size_x,size_y,tra_lon,tra_lat,rot);
 %
 ...
 %  (c) 2008, Jeroen Molemaker, UCLA
   ...
   dlon = 2*pi; % full earth
%  lon1d = dlon*[0:1:nl]/nl - dlon/2;  
   lon1d = dlon*[-0.5:1:nl+0.5]/nl - dlon/2;   % around zero lon
   mul = 1;
